<template>
    ...
    <div id="meQrcode">
        <div class="qrcode_box">
          ...
          <img  v-if="qrLogo" class="qrcode_logo" id="qrcode_logo" ref="qrcode_logo" :src="qrLogo" alt="二维码logo">
          <canvas :width="qrSize" :height="qrSize" id="qr-canvas" class="canvas" ref="canvas"></canvas>
        </div>
    </div>
</template>
<script>
...
export default {
  ...
  mounted() {
    ...
    let qrcode_canvas = document.getElementById("qrcode_canvas");
    let qrcode_logo = document.getElementById("qrcode_logo");
